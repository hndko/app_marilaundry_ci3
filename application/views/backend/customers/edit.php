                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Masukan Nomor Telepon" value="<?= $customer->phone ?>" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="address" name="address" placeholder="Masukan Alamat Lengkap"><?= $customer->address ?></textarea>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
